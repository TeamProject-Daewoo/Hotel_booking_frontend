...
import RegistrationFailedView from '../views/RegistrationFailedView.vue';
...
const routes = [
  ...
  {path: '/registration-failed', name: 'RegistrationFailedView', component: RegistrationFailedView},
